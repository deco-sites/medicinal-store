...
const ModalCoupon = ({
  image =
    "https://assets.decocache.com/medicinal-store/fbdb3f78-e999-4c17-ab2f-940abfa51da9/Rectangle-10.png",
          ...
          <div class="flex flex-col gap-8 lg:flex-row items-center text-center lg:text-center">
            ...
            <div class="flex flex-col gap-8 w-full max-w-[290px]">
              <p class="text-2xl text-accent uppercase font-semibold">
                SEJA BEM-VINDO! AQUI TEM UM{" "}
                <span class="text-primary">CUPOM DE DESCONTO EXCLUSIVO :)</span>
              </p>
                ...
                <div class="flex items-center justify-center gap-1">
                  ...
                  >
                    <Icon
                      ...
                      width={16}
                      height={16}
                      fill={copied ? "green" : "currentColor"}
                    />
                  </button>
                </div>

                <p class="text-accent flex gap-1 items-center justify-center">
                  <Icon id="document" width={16} height={16} />{" "}
