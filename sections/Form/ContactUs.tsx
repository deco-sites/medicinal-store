    ...
    return (
        <div>
            <div class="container p-4 mx-auto w-full relative">
                ...
                >
                    <div class="uppercase font-bold text-sm md:text-base">Envie sua mensagem</div>
                    <input
                    ...
                    <label class="label gap-2 text-sm justify-start p-0">
                        <input required name="" type="checkbox" class="checkbox checkbox-primary" />
                        <span>
                            Estou de acordo com a <a class="inline font-bold underline" target="_blank" href="/politicas-de-privacidade">política de privacidade</a> da Medicinal.
                        </span>
                    </label>
                    <label class="label gap-2 text-sm justify-start p-0">
                        <input name="whatsAppNews" type="checkbox" class="checkbox checkbox-primary" />
                        Quero receber novidades e ofertas por WhatsApp.
                    </label>
                    <label class="label gap-2 text-sm justify-start p-0">
                        <input name="emailNews" type="checkbox" class="checkbox checkbox-primary" />
