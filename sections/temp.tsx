    ...
    <div class="flex flex-col justify-center items-center min-h-screen bg-gray-100 text-gray-800 text-center p-4">
      <div class="p-8 rounded-lg bg-white shadow-lg max-w-lg">
        <svg
          ...
          stroke-width="1.5"
          stroke="currentColor"
          class="w-24 h-24 mx-auto text-green-500 mb-6"
        >
          <path
        ...
        <p class="text-xl leading-relaxed">
          Nosso site está passando por uma grande reforma para oferecer a você a
          melhor experiência possível. Voltaremos em breve com muitas novidades!
        </p>
